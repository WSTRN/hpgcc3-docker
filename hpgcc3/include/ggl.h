...
/*!
 * \defgroup gglmainpage GGL - Grayscale Graphics Library
 *
 ...
 * - Antialiased lines
 * 
 * For a detailed reference of each function see \ref ggl.h
 */
...
/*!
 * \brief Free the buffer allocated by ::ggl_initscr().
 *
